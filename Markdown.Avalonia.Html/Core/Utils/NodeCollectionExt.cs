...
internal static class NodeCollectionExt
{
    ...
    public static bool IsComment(this HtmlNode node)
    {
        return node is HtmlCommentNode;
    }
    ...
    public static bool HasOneTag(
        ...
        [MaybeNullWhen(false)] out HtmlNode child)
#else
            out HtmlNode child)
#endif
    {
        var children = list.CollectTag(tagName);
