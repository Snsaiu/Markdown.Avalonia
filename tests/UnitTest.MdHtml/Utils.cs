...
public static class Utils
{
    ...
    public static string GetRuntimeName()
    {
        ...
        if (description.Contains("framework")) return "framework";

        if (description.Contains("core")) return "core";

        if (description.Contains("native")) return "native";
