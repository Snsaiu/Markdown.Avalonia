...
public partial class MainWindow : Window
{
    ...
    private void SetupComponent()
    {
        ...
        var engine = new Avalonia.Markdown();
        ...
        TabItem.IsSelectedProperty.Changed.AddClassHandler<TabItem>((ctrl, x) =>
            {
        ...
        MarkdownScrollViewer.MarkdownProperty.Changed.AddClassHandler<MarkdownScrollViewer>((ctrl, x) =>
            {
