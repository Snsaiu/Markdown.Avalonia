...
{
    private readonly Lazy<Border> _block;
    private readonly CTextBlockElement _child;
    private readonly TextAlignment? _indiAlignment;
    ...
    private Border Create()
    {
        ...
        if (_indiAlignment.HasValue) note.TextAlignment = _indiAlignment.Value;
