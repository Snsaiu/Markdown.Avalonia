...
public class MarkdownScrollViewer : Control
{
    ...
    public bool SelectionEnabled
    {
        ...
        set => Focusable = _selectionEnabled = value;
    }
    ...
    private void OnScrollChanged()
    {
        ...
        var offsetY = _viewer.Offset.Y;
        var viewHeight = _viewer.Viewport.Height;
    ...
    private void UpdateMarkdown()
    {
        ...
        if (_wrapper.Document?.Control is Control oldContentControl) oldContentControl.SizeChanged -= OnViewportSizeChanged;

        _wrapper.Document = _document;

        if (_wrapper.Document?.Control is Control newContentControl) newContentControl.SizeChanged += OnViewportSizeChanged;
    ...
    private class Wrapper : Control, ISelectionRenderHelper
    {
